...
func (r *ownerStaffRepository) GetStaffByOwnerID(ownerID string) ([]models.OwnerStaffResponse, error) {
	...
	err := r.db.Table("owner_staffs").
		Select("owner_staffs.id, owner_staffs.owner_user_id, owner_staffs.staff_user_id, users.username, users.phone, owner_staffs.role_code, owner_staffs.status, owner_staffs.created_at, owner_staffs.updated_at").
